 ...
 * the pinned 0.153.4 app-server sends the canonical v2 signal instead:
...
// against the bundled codex-cli 0.153.4 native binary's embedded protocol types
...
// Shapes verified with `codex app-server generate-ts` from codex-cli 0.153.4:
